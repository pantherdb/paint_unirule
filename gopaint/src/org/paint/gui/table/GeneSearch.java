...
public class GeneSearch {
	...
	public static synchronized GeneSearch inst() {
        ...
        public List<GeneNode> search(List<GeneNode> allNodes, HashSet<String> searchSet) {
            HashSet<GeneNode> allMatches = new HashSet<GeneNode>();
            if (null != searchSet) {
                for (String searchStr: searchSet) {
                    List<GeneNode> matches = search(allNodes, searchStr);
                    allMatches.addAll(matches);
                }
            }
            return new ArrayList<GeneNode>(allMatches);
        }
