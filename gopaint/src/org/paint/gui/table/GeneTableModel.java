...
public class GeneTableModel extends AbstractGeneTableModel {
	...
	public static final String DESC_COL_NAME = "Description";
        ...
        public static final String COL_EC_NUM = "EC Num";
        public static final String COL_CCFU = "CCFU";
        public static final String COL_DEAF = "DEAF";
        public static final String COL_RHEA = "RHEA";
        public static final String COL_CCLO = "CCLO";
        public static final String COL_DEAE = "DEAE";        
...
//	}
	...
	public String getTextAt(int rowIndex, int columnIndex) {
		...
		if (tag.equals(ORTHO_COL_NAME)) {
			...
			Node n = node.getNode();
                ...
                else if (COL_REVIEWED.equals(tag)) {
                        Node n = node.getNode();
                        if (null != n) {
                            NodeStaticInfo sni = n.getStaticInfo();
                            if (null != sni) {
                                //System.out.println("Public id is " + sni.getPublicId());
                                return Boolean.toString(sni.isReviewed());
                            }
                        }                    
                }
                else if (COL_EC_NUM.equals(tag)) {
                        Node n = node.getNode();
                        if (null != n) {
	...
	public boolean isSquare(int column) {
		return (getColumnName(column).equals(ORTHO_COL_NAME) || getColumnName(column).equals(COL_REVIEWED));
	}
