...
implements FamilyChangeListener{
    ...
    private static final String LABEL_UPDATE_COLORS_THRESHOLD = "Edit msa colors/thresholds";
    private static final String LABEL_EXPORT_MSA = "Export MSA";
...
//		add(weightedItem);
		...
		JMenuItem updateMSA = new JMenuItem(LABEL_UPDATE_COLORS_THRESHOLD);
