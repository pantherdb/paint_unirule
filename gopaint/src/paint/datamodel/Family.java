...
public class Family implements Serializable {
    ...
    private ArrayList<CaseTypeDetails> errorPaintCases;
    private ArrayList<Rule> rulesSpecificToFamily;
    
    private UniRuleType unirule;
    private Boolean uniruleOpSucc = null;
    private  LoadFamilyDomain familyDomainWorker;
    private StringBuffer uniruleErrorBuf;
    private String uniRuleCommentExternal;
    private String uniRuleCommentInternal;
    private int newRuleCounter = -1;
    ...
    public synchronized int getNextRuleId() {
        newRuleCounter++;
        return newRuleCounter;
    }
    ...
    public boolean loadFamily(String familyID) {
        ...
        LoadUnirule uniruleWorker =  new LoadUnirule(familyID);
        ...
        unirule = uniruleWorker.uniruleType;
        uniruleOpSucc = uniruleWorker.opSuccess;
...
//	}
    ...
    public ArrayList<CaseTypeDetails> getErrorPaintCases() {
        return errorPaintCases;
    }

    public void setErrorPaintCases(ArrayList<CaseTypeDetails> errorPaintCases) {
        this.errorPaintCases = errorPaintCases;
    }

    public ArrayList<Rule> getRulesSpecificToFamily() {
        return rulesSpecificToFamily;
    }

    public void setRulesSpecificToFamily(ArrayList<Rule> rulesSpecificToFamily) {
        this.rulesSpecificToFamily = rulesSpecificToFamily;
    }
...
//	}
    ...
    public UniRuleType getUnirule() {
        return unirule;
    }

    public Boolean getUniruleOpSucc() {
        return uniruleOpSucc;
    }

    public StringBuffer getUniruleErrorBuf() {
        return uniruleErrorBuf;
    }

    public void setUniruleErrorBuf(StringBuffer uniruleErrorBuf) {
        this.uniruleErrorBuf = uniruleErrorBuf;
    }

    public String getUniRuleCommentInternal() {
        return uniRuleCommentInternal;
    }

    public void setUniRuleCommentInternal(String uniRuleCommentInternal) {
        this.uniRuleCommentInternal = uniRuleCommentInternal;
    }

    public String getUniRuleCommentExternal() {
        return uniRuleCommentExternal;
    }

    public void setUniRuleCommentExternal(String uniRuleCommentExternal) {
        this.uniRuleCommentExternal = uniRuleCommentExternal;
    }
...
//            msa = null;
    ...
    public class LoadUnirule implements Runnable {
        ...
        LoadUnirule(String familyId) {
            this.familyId = familyId;
        }
        
        public void run() {
            ArrayList<Boolean> successList = new ArrayList<Boolean>();
            uniruleType = UniruleSoapHelper.getRuleForFamily(familyId, successList);
