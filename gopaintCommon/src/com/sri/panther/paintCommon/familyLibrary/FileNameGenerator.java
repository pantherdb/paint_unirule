...
//  protected static final String DIR_BETE = "bete";
  ...
  public static final int MSA_INDEX_MIA = 1;  
    ...
    public static boolean IsXMLFileNameValid(String XMLFileName) {
        if (null != XMLFileName && XMLFileName.endsWith(DOT + XML_SUFFIX)) {
            return true;
        }
        return false;
    }
    ...
    public static String formatXMLFileName(String XMLFileName) {
        if (true == IsXMLFileNameValid(XMLFileName)) {
            return XMLFileName;
        } else {
            return XMLFileName + DOT + XML_SUFFIX;
        }
    }        
