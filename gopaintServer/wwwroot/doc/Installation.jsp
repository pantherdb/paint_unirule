    ...
    <body>
        ...
        <ol type="I">
            <li>Save the certificate to your system.
                <ol>
                    <li>Open the web browser to the website from which the application was downloaded, for example https://unirule.paint.usc.edu. Note, images are for go.paint.usc.edu, but, instructions apply for unirule.paint.usc.edu</li>
                    ...
                    <li>The certificate has to be added to the Java Truststore using a command. First, determine where it should be stored. Depending on the system, it should be stored in a Java lib/security directory in file cacerts as given in the table below:
                            ...
                            <ol type="I">
                                ...
                                <li>To execute the keytool command from the Java executable directory, in MAC as root, is as follows, change directory location as necessary:
                                    <ul>
                                        <li>sudo keytool -import -alias unirulepaintuscedu -file ~/Downloads/unirule-paint-usc-edu.pem -keystore /Library/Java/JavaVirtualMachines/jdk-11.jdk/Contents/Home/lib/security/cacerts</li>
                                ...
                                <li>To execute the keytool command from the Java executable directory, in Windows, is as follows:
                                    <ul>
                                        <li>C:\Program Files\Java\jdk-11.0.10\bin>keytool -import -alias unirulepaintuscedu -file C:\Users\my_user_name\Downloads\unirule-paint-usc-edu.pem -keystore "C:\Program Files\Java\jdk-11.0.10\lib\security\cacerts"</li>
                                    </ul>
                                </li>
                                <li>Note, the name of the alias for the certificate being added is 'unirulepaintuscedu'</li>
