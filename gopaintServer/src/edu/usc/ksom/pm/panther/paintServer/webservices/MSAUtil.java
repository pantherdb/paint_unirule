...
public class MSAUtil {
     ...
     * @param msaInfo
     * @param nodes
     * @param checkForAllNodes - indicates if msg should be output, if there exists a node in the MSA data that does not appear in the list of nodes 
     */
    public static void parsePIRForNonGO(Vector msaInfo,  Vector<AnnotationNode> nodes, boolean checkForAllNodes){
...
//            }
          ...
          if (true == checkForAllNodes && found == false) {
