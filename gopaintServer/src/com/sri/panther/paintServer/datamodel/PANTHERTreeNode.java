...
public class PANTHERTreeNode implements Serializable{

    protected PANTHERTreeNode parent;
    private Vector<PANTHERTreeNode> children;
    ...
    private Vector<String> geneIdentifierList;
    private Vector<String> geneSymbolList;
    private Hashtable<String, Vector<String>> identifierTbl;
